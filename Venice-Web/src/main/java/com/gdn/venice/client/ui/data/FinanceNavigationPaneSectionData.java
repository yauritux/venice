	...
	private static NavigationPaneTreeNodeRecord[] records;
	  ...
	  public static NavigationPaneTreeNodeRecord[] getNewRecords() {
		return new NavigationPaneTreeNodeRecord[]{
		  ...
		  new NavigationPaneTreeNodeRecord("17", "2", "Sales Settlement Report", NameTokens.financeSalesSettlementReport, "FM16", DataWidgetNameTokens.FIN_SALESSETTLEMENTREPORTTREENODE)
		};
	  }
}
