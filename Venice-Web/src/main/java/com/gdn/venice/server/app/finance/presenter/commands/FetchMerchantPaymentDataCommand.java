	...
	public RafDsResponse execute() {
		...
		try {
			...
			for (int i=0;i<finSalesRecordList.size();i++) {
                ...
                String partyName = salesRecord.getVenOrderItem().getVenMerchantProduct() != null ? (salesRecord.getVenOrderItem().getVenMerchantProduct().getVenMerchant() != null ? (salesRecord.getVenOrderItem().getVenMerchantProduct().getVenMerchant().getVenParty() != null
				...
				if (partyName!=null) {
					...
					if(i>0){
                        String partyNameLast = finSalesRecordList.get(i - 1).getVenOrderItem().getVenMerchantProduct() != null ? (finSalesRecordList.get(i - 1).getVenOrderItem().getVenMerchantProduct().getVenMerchant() != null ? (finSalesRecordList.get(i - 1).getVenOrderItem().getVenMerchantProduct().getVenMerchant().getVenParty() != null
                    ...
                    List<VenSettlementRecord> VenSettlementRecordList = VenSettlementRecordHome.queryByRange("select o from VenSettlementRecord o "
                            + "where o.venOrderItem.orderItemId = " + salesRecord.getVenOrderItem().getOrderItemId(), 0, 0);
                    ...
                    String selectManualJournalTransaction = "select o from FinApManualJournalTransaction o "
                            + " where o.venParty.fullOrLegalName = '" + partyName.replace("'", "''")
                            + "' and o.finJournalTransaction.finAccount.accountDesc='PIUTANG MERCHANT' "
                            + " and (o.finJournalTransaction.unpaidTransactionAmount <> 0 or o.finJournalTransaction.unpaidTransactionAmount is null)"
					...
					if(i!=finSalesRecordList.size()-1){
                        String partyNameNext = finSalesRecordList.get(i + 1).getVenOrderItem().getVenMerchantProduct() != null ? (finSalesRecordList.get(i + 1).getVenOrderItem().getVenMerchantProduct().getVenMerchant() != null ? (finSalesRecordList.get(i + 1).getVenOrderItem().getVenMerchantProduct().getVenMerchant().getVenParty() != null
                                ? finSalesRecordList.get(i + 1).getVenOrderItem().getVenMerchantProduct().getVenMerchant().getVenParty().getFullOrLegalName() : null) : null) : null;
