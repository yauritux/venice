        ...
        try {
            ...
            if (airwayBill.getGdnReference() != null && !airwayBill.getGdnReference().equals("")) {
                ...
                try {
                    ...
                    Double insured = awbTransaction.getQtyProduk() * awbTransaction.getHargaProduk() + (awbTransaction.getShippingCost() == null ? Double.valueOf("0") : awbTransaction.getShippingCost().doubleValue());
                    ...
                    totalCharge = awbTransaction.getShippingCost().add(awbTransaction.getInsuranceCost()).toString();
            ...
            if (contactDetailListRecipient.size() > 0) {
                for (int j = 0; j < contactDetailListRecipient.size(); j++) {
                    /**
                     * Get mobile no from venice when data is before airway bill
                     * automation
                     */
                    if (airwayBill.getGdnReference() != null && !airwayBill.getGdnReference().equals("")) {
            ...
            if (airwayBill.getVenOrderItem().getMerchantDeliveredDateStart() != null) {
                deliveredDate = sdf.format(airwayBill.getVenOrderItem().getMerchantDeliveredDateStart());
            }
            if (airwayBill.getVenOrderItem().getMerchantDeliveredDateEnd() != null) {
                deliveredDate += " - " + sdf.format(airwayBill.getVenOrderItem().getMerchantDeliveredDateEnd());
            }
            if (airwayBill.getVenOrderItem().getMerchantInstallationDateStart() != null) {
                instalationDate = sdf.format(airwayBill.getVenOrderItem().getMerchantInstallationDateStart());
            }
            if (airwayBill.getVenOrderItem().getMerchantInstallationDateEnd() != null) {
                instalationDate += " - " + sdf.format(airwayBill.getVenOrderItem().getMerchantInstallationDateEnd());
            }
