...
public class NCSActivityReportDataFilterTest {
	@Mock
	...
	private NCSActivityReportDataFilter sut;
	...
	public void setup(){
		...
		sut = new NCSActivityReportDataFilter();
	...
	public void filter_orderItemNotFound_orderItemRemovedFromList() throws ActivityReportDataFilterException{
		DailyReportNCS ncsItem = new DailyReportNCS();
		ncsItem.setRefNo(GDN_REF);
		
		ArrayList<PojoInterface> orderItemList = new ArrayList<PojoInterface>();
		orderItemList.add(ncsItem);
	...
	public void filter_gdnRefFormatInvalid_gdnRefNotFoundWillNotEmpty() throws ActivityReportDataFilterException{
		DailyReportNCS ncsItem = new DailyReportNCS();
		ncsItem.setRefNo("O-1378612-4293114-1/O-1378612-4293114-2");
