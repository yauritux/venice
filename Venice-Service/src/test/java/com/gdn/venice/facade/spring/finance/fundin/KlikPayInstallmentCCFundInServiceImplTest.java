...
public class KlikPayInstallmentCCFundInServiceImplTest {
	...
	public void setup(){
		...
		KlikPayInstallmentCCFundInServiceImpl bca = new KlikPayInstallmentCCFundInServiceImpl();
		sut = spy(bca);
