...
public class FailedStatusUpdate {
    ...
    /**
     * @return the usedOnItems
     */
    public String getUsedOnItems() {
        return usedOnItems;
    }

    /**
     * @param usedOnItems the usedOnItems to set
     */
    public void setUsedOnItems(String usedOnItems) {
        this.usedOnItems = usedOnItems;
    }
}
