...
public class AirwayBillEngineDummyConnector implements AirwayBillEngineConnector {
    ...
    /**
     * client.updateStatusToCX(airwayBillNumber, logisticProviderCode, user,
     * actualPickupTime, receiver, receiverRelation, receivedDate)
     */
    ...
    /**
     * client.updateStatusToD(airwayBillNumber, logisticProviderCode, user,
     * receiver, receiverRelation, receivedDate)
     */
    ...
    public boolean overrideAirwayBillNumber(String gdnRefNo, String awbNo,
            String user, String logProviderCode) {
        return false;
    }
	...
	public List<AirwayBillTransaction> getAirwayBillTransactionByReturnItem(String wcsOrderItemId)
			throws Exception {
		return null;
	}
