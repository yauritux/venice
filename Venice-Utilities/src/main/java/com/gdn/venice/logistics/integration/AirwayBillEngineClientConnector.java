...
public class AirwayBillEngineClientConnector implements AirwayBillEngineConnector {
    ...
    @Override
	public String getReturnGDNRef(String wcsOrderItemId) throws Exception {
        List<AirwayBillTransaction> awbList = getAirwayBillTransactionByReturnItem(wcsOrderItemId);
    ...
    @Override
    public boolean forceUpdateAirwayBillToCX(String gdnRefNo, String user, Timestamp actualPickupTime, String receiver, String receiverRelation, Timestamp receivedDate) throws Exception {

        Response res = client.updateStatusToCX(gdnRefNo, user, actualPickupTime, receiver, receiverRelation, receivedDate, true);
    ...
    @Override
    public boolean forceUpdateAirwayBillToD(String gdnRefNo, String user, Timestamp actualPickupTime, String receiver, String receiverRelation, Timestamp receivedDate) throws Exception {

        Response res = client.updateStatusToD(gdnRefNo, user, receiver, receiverRelation, receivedDate, true);
    ...
    @Override
    public boolean overrideAirwayBillNumber(String gdnRefNo, String awbNo, String user, String logProviderCode) {

        Response res = client.overrideAwbNo(gdnRefNo, awbNo, user, logProviderCode);
    ...
    @Override
	public List<AirwayBillTransaction> getAirwayBillTransactionByReturnItem(String wcsOrderItemId) throws Exception {
        GetAirwayBillTransactionResponse res = client.getAirwayBillTransaction(null, wcsOrderItemId, false, false, "venice", true);
