...
public class Locator<T> {
	...
	public static VeniceEnvironment veniceEnv = VeniceEnvironment.PRODUCTION; //default to PROD Environment
	...
	public Locator() throws Exception {
		...
		switch (veniceEnv) {
		case TESTING:
			return; // no need to create real object in TESTING Environment
		default: //continue to the next line
		}
