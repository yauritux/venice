...
@GeneratedValue(strategy=GenerationType.TABLE, generator="ven_order_item")  
	...
	@Column(name="sales_batch_status", length=50)
     ...
     * @return the cxDate
     */
    public Timestamp getCxDate() {
        return cxDate;
    }

    /**
     * @param cxDate the cxDate to set
     */
    public void setCxDate(Timestamp cxDate) {
        this.cxDate = cxDate;
    }

    /**
     * @return the cxMtaDate
     */
    ...
    /**
     * @param cxMtaDate the cxMtaDate to set
     */
