...
public class VenOrderPayment implements Serializable {
	...
	@Column(name="installment_sent_date", nullable=true)
	private Timestamp installmentSentDate;
	
	@Column(name="installment_sent_flag", nullable=true)
	...
	public Timestamp getInstallmentSentDate() {
		return installmentSentDate;
	}


	public void setInstallmentSentDate(Timestamp installmentSentDate) {
	...
	public Timestamp getInstallmentCancelDate() {
