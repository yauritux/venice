...
/**
 * Same Product Name & Customer Email in one week
 */
@Service("Rule27")
public class Rule27Impl implements Rule{
	private static final String CLASS_NAME = Rule27Impl.class.getCanonicalName();
	...
	public int getRiskPoint(VenOrder order){
		...
		FrdParameterRule26272829 rule = frdParameterRule26272829DAO.findByRule27OrderFromSameCustomerSameProductInOrderDateRange(orderWithCustomer.getVenCustomer().getCustomerId(), startDate, endDate, order.getOrderId());
