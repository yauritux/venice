            ...
            if (!existingVenOrderItem.getVenOrderStatus().getOrderStatusId().equals(venOrderItem.getVenOrderStatus().getOrderStatusId())) {
                ...
                if ((existingStatus == VeniceConstants.VEN_ORDER_STATUS_PU && newStatus == VeniceConstants.VEN_ORDER_STATUS_ES)
                    ...
                    if (existingStatus == VeniceConstants.VEN_ORDER_STATUS_PF && newStatus == VeniceConstants.VEN_ORDER_STATUS_FP) {
                        ...
                        List<VenOrder> venOrderList = orderHome.queryByRange("select o from VenOrder o join fetch oi.venOrderItems oi where o.wcsOrderId ='" + venOrderItem.getVenOrder().getWcsOrderId() + "'", 0, 0);
