...
@Service("KlikPayInstallmentCCFundInServiceImpl")
public class KlikPayInstallmentCCFundInServiceImpl extends AbstractFundInService{
	private static final FinArFundsInReportTypeConstants REPORT_TYPE = FinArFundsInReportTypeConstants.FIN_AR_FUNDS_IN_REPORT_TYPE_KLIKPAYINST_CC;
	private static final String CLASS_NAME = KlikPayInstallmentCCFundInServiceImpl.class.getCanonicalName();
