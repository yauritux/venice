...
public class FinArFundsInReportSessionEJBBean implements FinArFundsInReportSessionEJBRemote,
	...
	@Autowired
	@Qualifier("BCACCFundInServiceImpl")
	FundInService fundInServiceBCACC;
	
	@Autowired
	@Qualifier("KlikPayCCFundInServiceImpl")
	FundInService fundInServiceKlikPayCC;
	...
	@Autowired
	@Qualifier("NiagaIBFundInServiceImpl")
	FundInService fundInServiceNiagaIB;
	...
	@Override
	public String processFundIn(String fileNameAndFullPath, FinArFundsInReportTypeConstants reportType, String userName){
		String result = null;
		
		try {
			switch (reportType) {
				case FIN_AR_FUNDS_IN_REPORT_TYPE_BCA_CC:
					result = fundInServiceBCACC.process(fileNameAndFullPath, userName);
					break;
				case FIN_AR_FUNDS_IN_REPORT_TYPE_KLIKPAY_CC:
					result = fundInServiceKlikPayCC.process(fileNameAndFullPath, userName);
					break;
				...
				case FIN_AR_FUNDS_IN_REPORT_TYPE_NIAGA_IB:
					result = fundInServiceNiagaIB.process(fileNameAndFullPath, userName);
					break;
				default:
					break;
			}
