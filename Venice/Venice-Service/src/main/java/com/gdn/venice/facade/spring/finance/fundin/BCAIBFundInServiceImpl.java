...
@Service("BCAIBFundInServiceImpl")
public class BCAIBFundInServiceImpl extends AbstractFundInService{
	private static final FinArFundsInReportTypeConstants REPORT_TYPE = FinArFundsInReportTypeConstants.FIN_AR_FUNDS_IN_REPORT_TYPE_BCA_IB;
	private static final String CLASS_NAME = BCAIBFundInServiceImpl.class.getCanonicalName();
