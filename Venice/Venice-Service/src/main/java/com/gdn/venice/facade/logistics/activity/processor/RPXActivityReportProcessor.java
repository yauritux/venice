...
import com.gdn.venice.facade.logistics.activity.parser.RPXActivityReportFileParser;
...
@Service("RPXActivityReportProcessor")
public class RPXActivityReportProcessor  extends ActivityReportProcessor {

	protected static Logger _log = Log4jLoggerFactory.getLogger("com.gdn.venice.facade.logistics.activity.processor.RPXActivityReportProcessor");
	
	@PersistenceContext
	EntityManager em;
	
	@Autowired
    @Qualifier("RPXActivityReportDataFilter")
	...
	ActivityReportFileParser fileParser = new RPXActivityReportFileParser();
...
//		}
	...
	private LogLogisticsProvider getLogLogisticsProvider(){
		...
		provider.setLogisticsProviderId(0L);
		provider.setLogisticsProviderCode("RPX");
