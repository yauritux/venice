 ...
 *
 * This callback object is used to implement creation of sales records and clock
 * KPI's etc. upon the approval of airway bills.
 *
...
//			existingAirwayBill.setVenDistributionCart(distributionCart);
    ...
    public Boolean onPostMerge(Object businessObject, EntityManager em, LogAirwayBill existingAirwayBill) {
        ...
        try {
            ...
            /**
             * this portion of code and all that are related to are moved to
             * LogActivityReportMDB
             */
...
//			}
    ...
    /**
     * createOrUpdateSalesRecord - creates or updates the sales record If the
     * sales record associated with the airway bill does not yet exist then
     * create it.If it already exists then recalculate it and update it.
     *
     * @param logAirwayBill
