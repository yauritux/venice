...
public class NCSActivityReportFileParser extends ActivityReportFileParser{

	protected static Logger _log = Log4jLoggerFactory.getLogger("com.gdn.venice.facade.logistics.activity.parser.NCSActivityReportFileParser");
