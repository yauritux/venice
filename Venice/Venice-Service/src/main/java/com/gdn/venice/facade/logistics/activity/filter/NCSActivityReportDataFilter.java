...
@Service("NCSActivityReportDataFilter")
public class NCSActivityReportDataFilter extends ActivityReportDataFilter{
	protected static Logger _log = Log4jLoggerFactory.getLogger("com.gdn.venice.facade.logistics.activity.filter.NCSActivityReportDataFilter");
