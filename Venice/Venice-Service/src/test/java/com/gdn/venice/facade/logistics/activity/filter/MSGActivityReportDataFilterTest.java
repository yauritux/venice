...
public class MSGActivityReportDataFilterTest {
	@Mock
	...
	private MSGActivityReportDataFilter sut;
	...
	public void setup(){
		...
		sut = new MSGActivityReportDataFilter();
	...
	public void filter_orderItemNotFound_orderItemRemovedFromList() throws ActivityReportDataFilterException{
		DailyReportMSG msgItem = new DailyReportMSG();
		msgItem.setRefNo(GDN_REF);
		
		ArrayList<PojoInterface> orderItemList = new ArrayList<PojoInterface>();
		orderItemList.add(msgItem);
	...
	public void filter_gdnRefFormatInvalid_gdnRefNotFoundWillNotEmpty() throws ActivityReportDataFilterException{
		DailyReportMSG msgItem = new DailyReportMSG();
		msgItem.setRefNo("O-1378612-4293114-1/O-1378612-4293114-2");
