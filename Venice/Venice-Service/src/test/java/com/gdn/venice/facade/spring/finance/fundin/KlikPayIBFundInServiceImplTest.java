...
public class KlikPayIBFundInServiceImplTest {
private KlikPayIBFundInServiceImpl sut;
	...
	public void setup(){
		...
		sut = new KlikPayIBFundInServiceImpl();
	}
	...
	public void mergeDuplicate_1FundIn_returns1FundIn(){
		BCA_VA_IB_Record fundIn1 = new BCA_VA_IB_Record();
	...
	private ArrayList<PojoInterface> get5FundInWith3DuplicateFundIn(){
		BCA_VA_IB_Record duplicateFundIn1 = new BCA_VA_IB_Record();
		...
		BCA_VA_IB_Record duplicateFundIn3 = new BCA_VA_IB_Record();
