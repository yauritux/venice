...
public interface FrdParameterRule26272829DAO extends JpaRepository<FrdParameterRule26272829, Long> {
	...
	public static final String FIND_BY_RULE_28_ORDERFROMSAMECUSTOMER_SAMEPRODUCTCATEGORY_IN_ORDERDATERANGE_SQL =
		...
		"     (select * from ven_order where customer_id= ?1 and order_date between ?2 and ?3 and order_id<>?4 ) b on a.order_id=b.order_id"+
	...
	public static final String FIND_BY_RULE_29_ORDERFROMSAMECUSTOMERADDRESS_IN_ORDERDATERANGE_SQL = 
		...
		"from Frd_Parameter_Rule_26_27_28_29 " +
		"where id= 29 " +
		" and (select count(*) from ven_order a inner join  ven_order_address b on a.order_id=b.order_id inner join ven_address c on b.address_id=c.address_id where a.order_date between ?1 and ?2 and a.order_id<> ?3 and  c.street_address_1 is not null"+
	...
	@Query(FIND_BY_RULE_26_ORDERFROMSAMECUSTOMER_IN_ORDERDATERANGE_SQL)
	public FrdParameterRule26272829 findByRule26OrderFromSameCustomerInOrderDateRange(Long customerId, String startOrderDate, String endOrdeDate, Long orderId);

	@Query(FIND_BY_RULE_27_ORDERFROMSAMECUSTOMER_SAMEPRODUCT_IN_ORDERDATERANGE_SQL)
	public FrdParameterRule26272829 findByRule27OrderFromSameCustomerSameProductInOrderDateRange(Long customerId, String startOrderDate, String endOrderDate, Long orderId);

	@Query(FIND_BY_RULE_28_ORDERFROMSAMECUSTOMER_SAMEPRODUCTCATEGORY_IN_ORDERDATERANGE_SQL)
	public FrdParameterRule26272829 findByRule28OrderFromSameCustomerSameProductCategoryInOrderDateRange(Long customerId, String startOrderDate, String endOrderDate, Long orderId);

	@Query(FIND_BY_RULE_29_ORDERFROMSAMECUSTOMERADDRESS_IN_ORDERDATERANGE_SQL)
	public FrdParameterRule26272829 findByRule29OrderFromSameCustomerAddressInOrderDateRange(String startOrderDate, String endOrderDate, Long orderId);
