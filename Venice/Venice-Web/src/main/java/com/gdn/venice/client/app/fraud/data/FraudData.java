...
//				new DataSourceBooleanField(DataNameTokens.VENBINCREDITLIMITESTIMATE_ISACTIVE, "Is Active")
	...
	public static RafDataSource getConvertInstallmentData() {
		DataSourceField[] dataSourceFields = {
				...
				new DataSourceTextField(DataNameTokens.VENORDERPAYMENTALLOCATION_VENORDER_WCSORDERID, "Order ID"),				
				new DataSourceTextField(DataNameTokens.VENORDERPAYMENTALLOCATION_VENORDERPAYMENT_WCSPAYMENTID, "Payment ID"),				
				new DataSourceTextField(DataNameTokens.VENORDERPAYMENTALLOCATION_VENORDERPAYMENT_REFERENCEID, "Auth Code"),
				new DataSourceTextField(DataNameTokens.VENORDERPAYMENTALLOCATION_VENORDERPAYMENT_VENWCSPAYMENTTYPE_WCSPAYMENTTYPEID, "Payment Type"),
				new DataSourceTextField(DataNameTokens.VENORDERPAYMENTALLOCATION_VENORDERPAYMENT_AMOUNT, "Amount"),				
		...
		RafDataSource retVal = new RafDataSource(
				"/response/data/*",
				GWT.getHostPageBaseURL() + InstallmentBCAPresenter.installmentBCAPresenterServlet + "?method=fetchConvertInstallmentData&type=DataSource",
				null,
				GWT.getHostPageBaseURL() + InstallmentBCAPresenter.installmentBCAPresenterServlet + "?method=updateConvertInstallmentData&type=DataSource",
				null,
				dataSourceFields); 
	...
	public static RafDataSource getCancelInstallmentData() {
		DataSourceField[] dataSourceFields = {
				new DataSourceTextField(DataNameTokens.VENORDERPAYMENTALLOCATION_VENORDERPAYMENT_ORDERPAYMENTID, "Ven Payment ID"),
				new DataSourceTextField(DataNameTokens.VENORDERPAYMENTALLOCATION_VENORDER_WCSORDERID, "Order ID"),				
				new DataSourceTextField(DataNameTokens.VENORDERPAYMENTALLOCATION_VENORDERPAYMENT_WCSPAYMENTID, "Payment ID"),				
				...
				new DataSourceTextField(DataNameTokens.VENORDERPAYMENTALLOCATION_VENORDER_VENCUSTOMER_CUSTOMERUSERNAME, "Customer Username"),
				new DataSourceTextField(DataNameTokens.VENCUSTOMER_VENPARTY_FULLORLEGALNAME, "Customer Name"),
				new DataSourceTextField(DataNameTokens.VENORDERPAYMENTALLOCATION_VENORDERPAYMENT_INSTALLMENTCANCELFLAG, "Cancel Installment")
				};
		dataSourceFields[0].setPrimaryKey(true);		
		
		RafDataSource retVal = new RafDataSource(
				"/response/data/*",
				GWT.getHostPageBaseURL() + InstallmentBCAPresenter.installmentBCAPresenterServlet + "?method=fetchCancelInstallmentData&type=DataSource",
				null,
				GWT.getHostPageBaseURL() + InstallmentBCAPresenter.installmentBCAPresenterServlet + "?method=updateCancelInstallmentData&type=DataSource",
				null,
				dataSourceFields); 
		
		return retVal;
	}
	public static RafDataSource getOrderHistoryData() {	
		DataSourceField[] dataSourceFields = {
				new DataSourceTextField(DataNameTokens.VENORDERPAYMENTALLOCATION_VENORDER_ORDERDATE,  "Order Date"),
				new DataSourceTextField(DataNameTokens.VENORDERPAYMENTALLOCATION_VENORDER_WCSORDERID,  "No Order"),	
				new DataSourceTextField(DataNameTokens.VENORDERPAYMENTALLOCATION_VENORDER_VENORDERITEMS_ORDERITEMID,  "No Order Item"),						
				new DataSourceTextField(DataNameTokens.VENORDERPAYMENTALLOCATION_VENORDER_VENORDERCONTACTDETAIL_EMAIL,  "Customer Email (Username)"),
				new DataSourceTextField(DataNameTokens.VENORDERPAYMENTALLOCATION_VENORDER_VENCUSTOMER_VENPARTY_FULLORLEGALNAME,  "Customer Name"),
				new DataSourceTextField(DataNameTokens.VENORDERPAYMENTALLOCATION_VENORDER_VENORDERITEMS_VENMERCHANTPRODUCT_WCSPRODUCTNAME,  "Product Name"),	
				new DataSourceTextField(DataNameTokens.VENORDERPAYMENTALLOCATION_VENORDER_VENORDERITEMS_VENADDRESS_VENCITY_CITYID,  "City Id"),						
				new DataSourceTextField(DataNameTokens.VENORDERPAYMENTALLOCATION_VENORDER_VENORDERITEMS_TOTAL,  "Total Payment"),
				new DataSourceTextField(DataNameTokens.VENORDERPAYMENTALLOCATION_VENORDER_VENORDERITEMS_VENMERCHANTPRODUCT_VENPRODUCTCATEGORIES_PRODUCTCATEGORY, "Department"),
				new DataSourceTextField(DataNameTokens.VENORDERPAYMENTALLOCATION_VENORDERPAYMENT_VENWCSPAYMENTTYPE_WCSPAYMENTCODE, "Billing Method"),
				new DataSourceTextField(DataNameTokens.VENORDERPAYMENTALLOCATION_VENORDERPAYMENT_MASKEDCREDITCARDNUMBER,  "Credit Card Number"),
				new DataSourceTextField(DataNameTokens.VENORDERPAYMENTALLOCATION_VENORDERPAYMENT_VENBANK_BANKSHORTNAME,  "Bank Penerbit"),	
				new DataSourceTextField(DataNameTokens.VENORDERPAYMENTALLOCATION_VENORDERPAYMENT_THREEDSSECURITYLEVELAUTH, "Eci"),
				new DataSourceTextField(DataNameTokens.VENORDERPAYMENTALLOCATION_VENORDER_VENORDERITEMS_VENADDRESS_STREETADDRESS1,  "Shipping Address"),						
				new DataSourceTextField(DataNameTokens.VENORDERPAYMENTALLOCATION_VENORDER_VENORDERCONTACTDETAIL_MOBILE,  "Customer Mobile Number"),
				new DataSourceTextField(DataNameTokens.VENORDERPAYMENTALLOCATION_VENORDER_VENORDERSTATUS_ORDERSTATUSCODE, "Status Order")
		};
		//dataSourceFields[0].setPrimaryKey(true);
		
		RafDataSource retVal = new RafDataSource(
				"/response/data/*",
				GWT.getHostPageBaseURL() + FraudCaseManagementPresenter.fraudCaseMaintenancePresenterServlet + "?method=fetchOrderHistory&type=DataSource",
				null,null,null,	
				dataSourceFields);		
	...
	public static RafDataSource getVenMIGSUploadMaster(String orderId) {	
		DataSourceField[] dataSourceFields = {
				new DataSourceTextField(DataNameTokens.MIGSMASTER_MERCHANTTRANSACTIONREFERENCE,  "Merchant Transaction Reference"),
				new DataSourceTextField(DataNameTokens.MIGSMASTER_RESPONSECODE,  "Response Code"),	
				new DataSourceTextField(DataNameTokens.MIGSMASTER_DIALECTCSCRESULTCODE,  "Dialect CSC Result Code"),						
				new DataSourceTextField(DataNameTokens.MIGSMASTER_CARDNUMBER,  "Card Number"),
				new DataSourceTextField(DataNameTokens.MIGSMASTER_VENORDERPAYMENT_THREEDSSECURITYLEVELAUTH,  "Eci")
		};
		//dataSourceFields[0].setPrimaryKey(true);
		
		RafDataSource retVal = new RafDataSource(
				"/response/data/*",
				GWT.getHostPageBaseURL() + FraudCaseManagementPresenter.fraudCaseMaintenancePresenterServlet + "?method=fetchMIGSUploadMaster&type=DataSource",
				null,null,null,	
				dataSourceFields);		

		HashMap<String, String> params = new HashMap<String, String>();	
		if (orderId != null) {			
			params.put(DataNameTokens.FRDFRAUDSUSPICIONCASE_VENORDER_WCSORDERID, orderId);
		} else {
			params.put(DataNameTokens.FRDFRAUDSUSPICIONCASE_VENORDER_WCSORDERID, "");
		}	
		retVal.getOperationBinding(DSOperationType.FETCH).setDefaultParams(params);
		return retVal;
	}    
