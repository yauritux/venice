...
public class EditShelfAddWIPDataCommand implements RafRpcCommand {
	...
	public EditShelfAddWIPDataCommand(String username, String data) {
	...
	public String execute() {
		...
		try {
			...
			shelfWrapper = shelfService.editShelfAddWIP(username, shelf, storageList);
