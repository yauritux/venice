 ...
 * @author Maria Olivia
 */
public class WarehouseNonActiveWithApprovalPresenter extends Presenter<WarehouseNonActiveWithApprovalPresenter.MyView, WarehouseNonActiveWithApprovalPresenter.MyProxy>
        implements WarehouseNonActiveWithApprovalUiHandler {
     ...
     */
    @ProxyCodeSplit
    @NameToken(NameTokens.warehouseNonActiveWithApprovalPage)
    public interface MyProxy extends Proxy<WarehouseNonActiveWithApprovalPresenter>, Place {
    }
    ...
    public interface MyView extends View,
            HasUiHandlers<WarehouseNonActiveWithApprovalUiHandler> {
     ...
     */
    @Inject
    public WarehouseNonActiveWithApprovalPresenter(EventBus eventBus, MyView view,
            MyProxy proxy, DispatchAsync dispatcher) {
        super(eventBus, view, proxy);
        getView().setUiHandlers(this);
        ((RafViewLayout) getView().asWidget()).setViewPageName(getProxy().getNameToken());
        getView().loadApprovalNonActiveWarehouseData(WarehouseData.getAllWarehouseInProcessData(MainPagePresenter.signedInUser, 1, 20,"NonActive"));
