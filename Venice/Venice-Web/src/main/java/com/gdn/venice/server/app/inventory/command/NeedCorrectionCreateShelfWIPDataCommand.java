...
public class NeedCorrectionCreateShelfWIPDataCommand implements RafRpcCommand {

	HashMap<String, String> shelfMap;
	String username, url;
	ShelfManagementService shelfService;

	public NeedCorrectionCreateShelfWIPDataCommand(String username, String data) {		
	...
	public String execute() {
		System.out.println("NeedCorrectionCreateShelfWIPDataCommand");
		...
		try {
			...
			shelfWrapper = shelfService.needCorrectionCreateShelfWIP(username, shelf);
