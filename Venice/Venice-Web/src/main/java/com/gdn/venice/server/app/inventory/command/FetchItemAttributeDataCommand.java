    ...
    public RafDsResponse execute() {
        ...
        try {
        	...
        	if(asnItemWrapper!=null && asnItemWrapper.isSuccess()){
        		...
        		WarehouseItem whItem = grnService.findWarehouseItem(itemId, whi.getWarehouse().getId().toString(), whi.getSupplier()!=null?whi.getSupplier().getId().toString():"", whi.getStockType());        		
