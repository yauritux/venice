...
public class EditShelfDataCommand implements RafRpcCommand {
	...
	public EditShelfDataCommand(String username, String data) {
	...
	public String execute() {
		System.out.println("EditShelfDataCommand");
		...
		try {
			...
			shelfWrapper = shelfService.editShelf(username, shelf, storageList);
