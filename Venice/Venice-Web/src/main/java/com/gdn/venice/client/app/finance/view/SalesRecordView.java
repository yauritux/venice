...
SalesRecordPresenter.MyView {
	...
	public void loadSalesRecordData(DataSource dataSource) {
		...
		salesRecordListGrid.getField(DataNameTokens.FINSALESRECORD_VENORDERITEM_VENMERCHANTPRODUCT_MERCHANTPRODUCTSKU).setWidth(100);		
		...
		salesRecordListGrid.getField(DataNameTokens.FINSALESRECORD_VENORDERITEM_VENORDER_VENORDERPAYMENTALLOCATIONS_VENORDERPAYMENT_FINARFUNDSINRECONRECORDS_FINARFUNDSINREPORT_FINARFUNDSINREPORTTYPE_PAYMENTREPORTTYPEDESC).setWidth(125);
		salesRecordListGrid.getField(DataNameTokens.FINSALESRECORD_VENORDERITEM_VENORDER_VENORDERPAYMENTALLOCATIONS_VENORDERPAYMENT_FINARFUNDSINRECONRECORDS_FINARFUNDSINREPORT_FINARFUNDSINREPORTTYPE_PAYMENTREPORTTYPEDESC).setCanFilter(false);
