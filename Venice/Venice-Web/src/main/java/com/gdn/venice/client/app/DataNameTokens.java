...
public class DataNameTokens {
	...
	public static String MIGSMASTER_VENORDERPAYMENT_THREEDSSECURITYLEVELAUTH = "VenMigsUploadMaster.venOrderPayment.ThreeDsSecurityLevelAuth";
...
//	public static String VENORDERITEM_VENMERCHANTPRODUCT_VENPRODUCTCATEGORIES_LEVEL = "VenOrderItem.venMerchantProduct.venProductCategories.venProductCategory.level";
	...
	public static String VENORDERITEM_VENADDRESS_VENCITY_CITYID="VenOrderItem.venAddress.venCity.cityId";
	public static String VENORDERITEM_VENMERCHANTPRODUCT_VENPRODUCTCATEGORIES_PRODUCTCATEGORIES = "VenOrderItem.venMerchantProduct.venProductCategories.productCategory";
	
	public static String VENPRODUCTCATEGORY_PRODUCTCATEGORIES = "VenProductCategory.productCategory";
	...
	public static String FINSALESRECORD_PAYMENT_STATUS = "FinSalesRecord.paymentStatus";
	public static String FINSALESRECORD_VENORDERITEM_VENSETTLEMENTRECORDS_PPH23_FLAG = "FinSalesRecord.venOrderItem.venSettlementRecords.pph23";
	public static String FINSALESRECORD_PPH23_AMOUNT = "FinSalesRecord.pph23Amount";
	public static String FINSALESRECORD_JUMLAH= "FinSalesRecord.jumlah";
	public static String FINSALESRECORD_FINAPPAYMENT_FINAPPROVALSTATUS_APPROVALID= "FinSalesRecord.finApPayment.finApprovalStatus.approvalStatusId";

	public static String FINSALESRECORD_VENORDERITEM_VENORDER_VENORDERPAYMENTALLOCATIONS_VENORDERPAYMENT_FINARFUNDSINRECONRECORDS_FINARFUNDSINREPORT_FINARFUNDSINREPORTTYPE_PAYMENTREPORTTYPEDESC="FinSalesRecord.venOrderItem.venOrder.venOrderPaymentAllocations.venOrderPayment.finArFundsInReconRecords.finArFundsInReport.finArFundsInReportType.paymentReportTypeDesc";
...
//	public static String VENDISTRIBUTIONCART_ITEMDESCRIPTION = "VenDistributionCart.itemDescription"; //NOT IMPLEMENTED IN VENDISTRIBUTIONCART
	...
	public static String VENORDERPAYMENTALLOCATION_VENORDERPAYMENT_VENPAYMENTTYPE_PAYMENTTYPECODE = "VenOrderPaymentAllocation.venOrderPayment.venPaymentType.paymentTypeCode";
	public static String VENORDERPAYMENTALLOCATION_VENORDERPAYMENT_VENPAYMENTTYPE_PAYMENTTYPEDESC = "VenOrderPaymentAllocation.venOrderPayment.venPaymentType.paymentTypeDesc";
	public static String VENORDERPAYMENTALLOCATION_VENORDERPAYMENT_VENWCSPAYMENTTYPE_WCSPAYMENTTYPEID = "VenOrderPaymentAllocation.venOrderPayment.venWcsPaymentType.wcsPaymentTypeId";
	...
	public static String VENORDERPAYMENTALLOCATION_VENORDERPAYMENT_VAORIBORCCNUMBER = "VenOrderPaymentAllocation.venOrderPayment.vaorbiorccNumber";
	public static String VENORDERPAYMENTALLOCATION_VENORDERPAYMENT_AMOUNT = "VenOrderPaymentAllocation.venOrderPayment.amount";
	public static String VENORDERPAYMENTALLOCATION_VENORDERPAYMENT_TENOR = "VenOrderPaymentAllocation.venOrderPayment.tenor";
	...
	public static String VENORDERPAYMENTALLOCATION_VENORDERPAYMENT_INSTALLMENTSENTFLAG = "VenOrderPaymentAllocation.venOrderPayment.installmentSentFlag";
	public static String VENORDERPAYMENTALLOCATION_VENORDERPAYMENT_INSTALLMENTCANCELFLAG = "VenOrderPaymentAllocation.venOrderPayment.installmentCancelFlag";
	public static String VENORDERPAYMENTALLOCATION_VENORDERPAYMENT_INSTALLMENTCANCELDATE = "VenOrderPaymentAllocation.venOrderPayment.installmentCancelDate";
	public static String VENORDERPAYMENTALLOCATION_VENORDERPAYMENT_THREEDSSECURITYLEVELAUTH = "VenOrderPaymentAllocation.venOrderPayment.threeDsSecurityLevelAuth";
	...
	public static String VENORDERPAYMENTALLOCATION_VENORDER_VENORDERITEM_ORDERITEMID="VenOrderPaymentAllocation.venOrder.venOrderItem.orderItemId";
	public static String VENORDERPAYMENTALLOCATION_VENORDER_VENCUSTOMER_VENPARTY_FULLORLEGALNAME="VenOrderPaymentAllocation.venOrder.venCustomer.venParty.fullOrLegalName";
	public static String VENORDERPAYMENTALLOCATION_VENORDERPAYMENT_VENWCSPAYMENTTYPE_WCSPAYMENTCODE="VenOrderPaymentAllocation.venOrderPayment.venWcsPaymentType.wcsPaymentTypeCode";
	public static String VENORDERPAYMENTALLOCATION_VENORDER_VENORDERITEMS_ORDERITEMID="VenOrderPaymentAllocation.venOrder.venOrderItems.orderItemId";
	public static String VENORDERPAYMENTALLOCATION_VENORDER_VENORDERITEMS_VENMERCHANTPRODUCT_WCSPRODUCTNAME = "VenOrderPaymentAllocation.venOrder.venOrderItems.venMerchantProduct.wcsProductName";
	public static String VENORDERPAYMENTALLOCATION_VENORDER_VENORDERITEMS_VENADDRESS_VENCITY_CITYID = "VenOrderPaymentAllocation.venOrder.venOrderItems.venAddress.venCity.cityId";
	public static String VENORDERPAYMENTALLOCATION_VENORDER_VENORDERITEMS_TOTAL = "VenOrderPaymentAllocation.venOrder.venOrderItems.total";
	public static String VENORDERPAYMENTALLOCATION_VENORDER_VENORDERITEMS_VENADDRESS_STREETADDRESS1 = "VenOrderPaymentAllocation.venOrder.venOrderItems.venAddress.streetAddress1";
	public static String VENORDERPAYMENTALLOCATION_VENORDER_VENORDERCONTACTDETAIL_EMAIL = "Email";
	public static String VENORDERPAYMENTALLOCATION_VENORDER_VENORDERCONTACTDETAIL_MOBILE = "Mobile";
	public static String VENORDERPAYMENTALLOCATION_VENORDER_VENORDERITEMS_VENMERCHANTPRODUCT_VENPRODUCTCATEGORIES_PRODUCTCATEGORY ="VenOrderPaymentAllocation.venOrder.venOrderItems.venMerchantProduct.venProductCategories.productCategory";
...
//	public static String FINARFUNDSINRECONRECORD_FINARRECONRESULT_RECONRESULTDESC = "FinArFundsInReconRecord.finArReconResult.reconResultDesc";
	...
	public static String FINARFUNDSINRECONRECORD_VENORDERPAYMENT_VENORDERPAYMENTALLOCATION_VENORDER_VENCUSTOMER_CUSTOMERUSERNAME ="FinArFundsInReconRecord.venOrderPayment.venOrderPaymentAllocations.venOrder.venCustomer.customerUserName";
	...
	public static String FINAPPAYMENT_APPAYMENTDATE = "FinApPayment.apPaymentDate";
	...
	public static String FINAPPAYMENT_FINAPPROVALSTATUS_APPROVALSTATUSID = "FinApPayment.finApprovalStatus.approvalStatusId";		
	...
	public DataNameTokens() {
		...
		fieldClassMap.put(MIGSMASTER_VENORDERPAYMENT_THREEDSSECURITYLEVELAUTH,"java.lang.string");
		...
		fieldClassMap.put(VENORDERPAYMENTALLOCATION_VENORDERPAYMENT_TENOR, "java.lang.Integer");		
...
//		fieldClassMap.put(VENDISTRIBUTIONCART_ITEMDESCRIPTION, "");
		...
		fieldClassMap.put(VENORDERPAYMENTALLOCATION_VENORDERPAYMENT_VENWCSPAYMENTTYPE_WCSPAYMENTTYPEID, "java.lang.Long");
		...
		fieldClassMap.put(VENORDERPAYMENTALLOCATION_VENORDERPAYMENT_INSTALLMENTSENTFLAG, "java.lang.Boolean");
		fieldClassMap.put(VENORDERPAYMENTALLOCATION_VENORDERPAYMENT_INSTALLMENTCANCELFLAG, "java.lang.Boolean");
		fieldClassMap.put(VENORDERPAYMENTALLOCATION_VENORDERPAYMENT_INSTALLMENTCANCELDATE, "java.sql.Timestamp");
		...
		fieldClassMap.put(VENORDERPAYMENTALLOCATION_VENORDERPAYMENT_OLDVENORDER_WCSORDERID, "java.lang.String");
		fieldClassMap.put(VENORDERPAYMENTALLOCATION_VENORDERPAYMENT_THREEDSSECURITYLEVELAUTH, "java.lang.String");
		fieldClassMap.put(VENORDERPAYMENTALLOCATION_VENORDER_VENORDERSTATUS_ORDERSTATUSCODE, "java.lang.String");
		fieldClassMap.put(VENORDERPAYMENTALLOCATION_VENORDER_VENORDERITEM_ORDERITEMID, "java.lang.Integer");
		fieldClassMap.put(VENORDERPAYMENTALLOCATION_VENORDER_VENCUSTOMER_VENPARTY_FULLORLEGALNAME, "java.lang.String");
		fieldClassMap.put(VENORDERPAYMENTALLOCATION_VENORDERPAYMENT_VENWCSPAYMENTTYPE_WCSPAYMENTCODE, "java.lang.String");
		fieldClassMap.put(VENORDERPAYMENTALLOCATION_VENORDER_VENORDERITEMS_VENMERCHANTPRODUCT_WCSPRODUCTNAME, "java.lang.String");
		fieldClassMap.put(VENORDERPAYMENTALLOCATION_VENORDER_VENORDERITEMS_VENADDRESS_VENCITY_CITYID, "java.lang.Integer");
		fieldClassMap.put(VENORDERPAYMENTALLOCATION_VENORDER_VENORDERITEMS_TOTAL, "java.lang.Integer");
		fieldClassMap.put(VENORDERPAYMENTALLOCATION_VENORDER_VENORDERITEMS_VENADDRESS_STREETADDRESS1, "java.lang.String");
		fieldClassMap.put(VENORDERPAYMENTALLOCATION_VENORDER_VENORDERCONTACTDETAIL_EMAIL, "java.lang.String");
		fieldClassMap.put(VENORDERPAYMENTALLOCATION_VENORDER_VENORDERCONTACTDETAIL_MOBILE, "java.lang.String");
		fieldClassMap.put(VENORDERPAYMENTALLOCATION_VENORDER_VENORDERITEMS_VENMERCHANTPRODUCT_VENPRODUCTCATEGORIES_PRODUCTCATEGORY, "java.lang.String");
		fieldClassMap.put(VENORDERPAYMENTALLOCATION_VENORDER_VENORDERITEMS_ORDERITEMID, "java.lang.Integer");
...
//		fieldClassMap.put(FINARFUNDSINRECONRECORD_RECONCILIATIONRECORDID, "java.lang.String");
		...
		fieldClassMap.put(FINARFUNDSINRECONRECORD_VENORDERPAYMENT_VENORDERPAYMENTALLOCATION_VENORDER_VENCUSTOMER_CUSTOMERUSERNAME, "java.lang.String");		
...
//		fieldClassMap.put(FINSALESRECORD_VENORDERITEM_LOGLOGISTICSERVICE_LOGLOGISTICSPROVIDER_VENPARTY_FULLORLEGALNAME, "java.lang.String");
		...
		fieldClassMap.put(FINAPPAYMENT_APPAYMENTDATE, "java.sql.Timestamp");			
