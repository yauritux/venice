...
public class FundInReconciliationView extends ViewWithUiHandlers<FundInReconciliationUiHandlers> implements FundInReconciliationPresenter.MyView {
	...
	public void loadFundInReconciliationData(DataSource dataSource, Map<String,String> paymentTypeMap, Map<String,String> bankMap,Map<String,String> parentPaymentReportMap) {
		...
		fundInReconciliationListGridWidget.getField(DataNameTokens.FINARFUNDSINRECONRECORD_VENORDERPAYMENT_VENORDERPAYMENTALLOCATION_VENORDER_VENCUSTOMER_CUSTOMERUSERNAME).setWidth(100);
		...
		buttonUpload.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				if (reportTypeSelectItem.getValueAsString().equals("BCA Virtual Account")) {
					uploadForm.setAction(host + "Venice/BCA_VA_ReportImportServlet?username=" + MainPagePresenter.signedInUser);
				} else if (reportTypeSelectItem.getValueAsString().equals("Mandiri Virtual Account")) {
					uploadForm.setAction(host + "Venice/Mandiri_VA_ReportImportServlet?username=" + MainPagePresenter.signedInUser);
					...
					uploadForm.setAction(host + "Venice/BCA_IB_ReportImportServlet?username=" + MainPagePresenter.signedInUser);
				} else if (reportTypeSelectItem.getValueAsString().equals("Mandiri Klikpay")) {
					uploadForm.setAction(host + "Venice/Mandiri_IB_ReportImportServlet?username=" + MainPagePresenter.signedInUser);
				}  else if (reportTypeSelectItem.getValueAsString().equals("CIMBClicks")) {
					uploadForm.setAction(host + "Venice/Niaga_IB_ReportImportServlet?username=" + MainPagePresenter.signedInUser);
					...
					uploadForm.setAction(host + "Venice/BCA_CC_ReportImportServlet?username=" + MainPagePresenter.signedInUser);
				}  else if ( reportTypeSelectItem.getValueAsString().equals("KlikPay Full Payment IB")) {
					uploadForm.setAction(host + "Venice/KlikPay_IB_ReportImportServlet?username=" + MainPagePresenter.signedInUser);
				}  else if (reportTypeSelectItem.getValueAsString().equals("KlikPay Full Payment CC")) {
					uploadForm.setAction(host + "Venice/KlikPay_CC_ReportImportServlet?username=" + MainPagePresenter.signedInUser);
				} else if (reportTypeSelectItem.getValueAsString().equals("KlikPay Installment CC")) {
					uploadForm.setAction(host + "Venice/KlikPayInst_CC_ReportImportServlet?username=" + MainPagePresenter.signedInUser);
				} else if (reportTypeSelectItem.getValueAsString().equals("XL Tunai")) {
					uploadForm.setAction(host + "Venice/XL_IB_ReportImportServlet?username=" + MainPagePresenter.signedInUser);
				} else if (reportTypeSelectItem.getValueAsString().equals("Mandiri Installment")) {
					uploadForm.setAction(host + "Venice/Mandiri_Installment_ReportImportServlet?username=" + MainPagePresenter.signedInUser);
				} else if (reportTypeSelectItem.getValueAsString().equals("BRI")) {
					uploadForm.setAction(host + "Venice/BRI_IB_ReportImportServlet?username=" + MainPagePresenter.signedInUser);
				} 
