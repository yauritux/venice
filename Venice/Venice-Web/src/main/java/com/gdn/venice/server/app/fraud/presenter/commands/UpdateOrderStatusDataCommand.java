...
public class UpdateOrderStatusDataCommand implements RafRpcCommand {
	...
	public UpdateOrderStatusDataCommand(String caseId, String method, String username) {
		...
		_log = loggerFactory
				.getLog4JLogger("com.gdn.venice.fraud.UpdateOrderStatusDataCommand");
	}
		...
		public String addToBlackList(String wcsOrderId, String username){
			...
			try{
				...
				if(orderList.size()>0){
					...
					_log.debug("get Shipping Address");
					...
					_log.debug("get nomor Credit Card");
					...
					_log.debug("fraud case check blacklist");				
