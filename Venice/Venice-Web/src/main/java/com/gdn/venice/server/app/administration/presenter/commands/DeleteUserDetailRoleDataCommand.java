...
public class DeleteUserDetailRoleDataCommand implements RafDsCommand {
	...
	public DeleteUserDetailRoleDataCommand(RafDsRequest request,  String username) {
		this.request = request;		
		this.username = username;		
		
        Log4jLoggerFactory loggerFactory = new Log4jLoggerFactory();
        _log = loggerFactory.getLog4JLogger("com.gdn.venice.administration.DeleteUserDetailRoleDataCommand");
	}
