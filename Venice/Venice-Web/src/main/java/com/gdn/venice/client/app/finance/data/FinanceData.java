...
public class FinanceData {
    ...
    public static RafDataSource getFundInReconciliationData() {
        DataSourceField[] dataSourceFields = {
            ...
            new DataSourceTextField(DataNameTokens.FINARFUNDSINRECONRECORD_VENORDERPAYMENT_VENORDERPAYMENTALLOCATION_VENORDER_VENCUSTOMER_CUSTOMERUSERNAME, "Customer Id"),	
    ...
    public static RafDataSource getSalesRecordData() {
        DataSourceField[] dataSourceFields = {
            ...
            new DataSourceDateField(DataNameTokens.FINSALESRECORD_SALESTIMESTAMP, "Created Date"),
    ...
    public static DataSource getRefundPaymentData(String refundRecordIdXml) {
    		DataSourceField[] dataSourceFields = {
    				...
    				new DataSourceFloatField(DataNameTokens.FINAPPAYMENT_BALANCE, "Balance"),
    				new DataSourceTextField(DataNameTokens.FINAPPAYMENT_FINACCOUNT_ACCOUNTID, "Bank Account"),
    				new DataSourceTextField(DataNameTokens.FINARFUNDSINREFUND_FEEAMOUNT, "Bank Fee"),
    				new DataSourceTextField(DataNameTokens.FINAPPAYMENT_FINAPMANUALJOURNALTRANSACTIONS, "FinApManualJournalTransactions"),
    ...
    /**
     * Gets the manual transaction payment data based on the sales record ids
     * and invoice ids
     *
    ...
    public static RafDataSource getPaymentData() {
    		DataSourceField[] dataSourceFields = {
    				new DataSourceIntegerField(DataNameTokens.FINAPPAYMENT_APPAYMENTID, "ID"),
    				new DataSourceDateField(DataNameTokens.FINAPPAYMENT_APPAYMENTDATE, "Payment Date"),
    				new DataSourceTextField(DataNameTokens.FINAPPAYMENT_FINACCOUNT_ACCOUNTDESC, "Bank Account"),
    ...
    public static DataSource getGetSalesSettlementRecord() {
        DataSourceField[] dataSourceFields = {        		
        		
        		
        		new DataSourceTextField(DataNameTokens.FINSALESRECORD_SALESRECORDID, "SalesID"),
        		new DataSourceTextField(DataNameTokens.FINSALESRECORD_VENORDERITEM_VENMERCHANTPRODUCT_VENMERCHANT_WCSMERCHANTID, "Merchant"),
        		new DataSourceTextField(DataNameTokens.FINSALESRECORD_VENORDERITEM_VENMERCHANTPRODUCT_VENMERCHANT_VENPARTY_FULLORLEGALNAME, "Merchant Name"),
        		new DataSourceDateField(DataNameTokens.FINSALESRECORD_CXF_DATE, "CX Finance Date "),       		        		
                new DataSourceTextField(DataNameTokens.FINSALESRECORD_VENORDERITEM_VENORDER_WCSORDERID, "OrderID"),
                new DataSourceTextField(DataNameTokens.FINSALESRECORD_VENORDERITEM_WCSORDERITEMID, "Order Item ID"),
                new DataSourceTextField(DataNameTokens.FINSALESRECORD_VENORDERITEM_VENMERCHANTPRODUCT_WCSPRODUCTNAME, "Keterangan"),
                new DataSourceTextField(DataNameTokens.FINSALESRECORD_VENORDERITEM_QUANTITY, "Qty"),
                new DataSourceTextField(DataNameTokens.FINSALESRECORD_VENORDERITEM_PRICE, "Harga Satuan"),
                new DataSourceTextField(DataNameTokens.FINSALESRECORD_VENORDERITEM_TOTAL, "Jumlah"),
                new DataSourceTextField(DataNameTokens.FINSALESRECORD_GDNCOMMISIONAMOUNT, "Komisi"),
                new DataSourceTextField(DataNameTokens.FINSALESRECORD_GDNTRANSACTIONFEEAMOUNT, "Biaya Transaksi"),
                new DataSourceTextField(DataNameTokens.FINSALESRECORD_PPH23_AMOUNT, "PPH23"),
                new DataSourceTextField(DataNameTokens.FINSALESRECORD_JUMLAH, "Total")
            };
            dataSourceFields[0].setPrimaryKey(true);

            RafDataSource dataSource = new RafDataSource(
                    "/response/data/*",
                    GWT.getHostPageBaseURL() + FinSalesSettlementReportPresenter.finSalesSettlementReportPresenterServlet + "?method=fetchSalesSettlementRecordData&type=DataSource",
                    null,
                    null,
                    null,
                    dataSourceFields);
