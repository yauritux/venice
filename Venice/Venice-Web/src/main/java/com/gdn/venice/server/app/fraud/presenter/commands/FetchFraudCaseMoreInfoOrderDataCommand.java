    ...
    public RafDsResponse execute() {
        ...
        try {
            ...
            if (request.getParams().get(DataNameTokens.VENCUSTOMER_VENPARTY_FULLORLEGALNAME) != null) {
                select = select + " and upper(o.venCustomer.venParty.fullOrLegalName) like '%" + request.getParams().get(DataNameTokens.VENCUSTOMER_VENPARTY_FULLORLEGALNAME).toString().toUpperCase().replace("'", "''") + "%'";
            }
            ...
            if (request.getParams().get(DataNameTokens.VENORDERITEM_VENRECIPIENT_VENPARTY_FULLORLEGALNAME) != null) {
                select = select + " and upper(r.fullOrLegalName) like '%" + request.getParams().get(DataNameTokens.VENORDERITEM_VENRECIPIENT_VENPARTY_FULLORLEGALNAME).toString().toUpperCase().replace("'", "''") + "%'";
            }
            if (request.getParams().get(DataNameTokens.VENORDERITEM_VENRECIPIENT_VENPARTY_VENCONTACTDETAIL_RECIPIENTHP) != null) {
            ...
            if (request.getParams().get(DataNameTokens.VENMERCHANT_VENPARTY_FULLORLEGALNAME) != null) {
                select = select + " and upper(m.fullOrLegalName) like '%" + request.getParams().get(DataNameTokens.VENMERCHANT_VENPARTY_FULLORLEGALNAME).toString().toUpperCase().replace("'", "''") + "%'";
            }
            if (request.getParams().get(DataNameTokens.VENORDERITEM_VENADDRESS) != null) {
                select = select + " and (upper(oia.venAddress.streetAddress1) like '%" + request.getParams().get(DataNameTokens.VENORDERITEM_VENADDRESS).toString().toUpperCase().replace("'", "''") + "%' "
