...
public class FraudCaseManagementLayout extends HLayout {
	...
	public FraudCaseManagementLayout(
			...
			final DataSource OrderHistListData,
			final DataSource migsUploadMaster
			) {
		...
		fraudCaseManagementTabSet.addTab(new FraudCaseManagementOrderTab("Order Detail", orderDetailData, orderItemData,migsUploadMaster));
		...
		fraudCaseManagementTabSet.addTab(new FraudCaseManagementMoreInfoTab("More Information", OrderHistListData));
