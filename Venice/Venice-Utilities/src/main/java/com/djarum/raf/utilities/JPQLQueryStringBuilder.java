...
public class JPQLQueryStringBuilder<T> {
     ...
     *
     * @param businessObject is the object to use for building the query. The
     * internal state of the object is used to build the query parameters.
     */
     ...
     *
     * @param complexTypeBindings is a Map of the complex type bindings to be
     ...
     *
     * @param complexTypeBindings - a Map with the caller side bindings for
     * complex types and java.util.Date specified as name/value pairs
     * @param criteria an advanced JPQL criteria object
...
//			localWhere = localWhere + ")";
    ...
    /**
     * Generic inner class to provide a converter for comma delimited values of
     * any supported type (types must have a constructor with a single
     * java.lang.String parameter) to a List object to be used for binding the
     * values of an IN clause in JPQL.
     *
     * Note that since the framework passes Date/Time types as Long values we
     * cannot use this mechanism and need type-specific methods
     *
     * <p> <b>author:</b> <a href="mailto:david@pwsindonesia.com">David
     * Forden</a> <p> <b>version:</b> 1.0 <p> <b>since:</b> 2011
     *
    ...
    /**
     * Convert a comma delimited string of java.util.Date long values into an
     * array
     *
     * @param value the comma delimited list of java.util.Date values in long
     * millisecond representation as a string
    ...
    /**
     * Convert a comma delimited string of java.sql.Date long values into an
     * array
     *
     * @param value the comma delimited list of java.sql.Date values in long
     * millisecond representation as a string
     * @return the new array
     */
    ...
    /**
     * Convert a comma delimited string of java.sql.Time long values into an
     * array
     *
     * @param value the comma delimited list of java.sql.Time values in long
     * millisecond representation as a string
     * @return the new array
     */
    ...
    /**
     * Convert a comma delimited string of java.sql.Timestamp long values into
     * an array
     *
     * @param value the comma delimited list of java.sql.Timestamp values in
     * long millisecond representation as a string
     * @return the new array
     */
