...
public interface AirwayBillEngineConnector {
	...
	public abstract List<AirwayBillTransaction> getAirwayBillTransactionByReturnItem(String wcsOrderItemId)
			throws Exception;

	public abstract String getReturnGDNRef(String wcsOrderItemId) throws Exception;
}
